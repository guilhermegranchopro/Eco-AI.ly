...
from backend.renewable_percentage.renewable_percentage_time_series import (
    render_time_series_RP,
)
from backend.renewable_percentage.renewable_percentage_ai import (
    render_ai_predictions_RP,
)
from backend.renewable_percentage.renewable_percentage_model_stats import (
    rend_model_stats_RP,
)
from backend.other_countries import get_expansion_message
from backend.renewable_percentage.renewable_percentage_info import (
    render_renewable_percentage_info,
)
from backend.renewable_percentage.renewable_percentage_report import (
    create_renewable_percentage_report_download_button,
)
from backend.renewable_percentage.renewable_percentage_arbitrage import (
    render_arbitrage_opportunity_RP,
)
...
def main():
    ...
    with tab1:
        ...
        arbitrage_value = render_arbitrage_opportunity_RP(
