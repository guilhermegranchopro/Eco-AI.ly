"use client";
import React, { useState, useEffect, useRef, ReactNode, useMemo, Suspense } from 'react';
import Image from 'next/image';
import Link from 'next/link';
import { motion, AnimatePresence, useAnimation, useMotionValue, useTransform, useSpring, animate, SpringOptions, useScroll, useVelocity, useSpring as useFramerSpring } from 'framer-motion';
import { useInView } from 'react-intersection-observer';
import { useTheme } from './theme-provider';
import { Canvas, useFrame } from '@react-three/fiber';
import { OrbitControls, Sphere, MeshDistortMaterial, Float, Text3D, Environment, PerspectiveCamera, Stars, Effects } from '@react-three/drei';
import * as THREE from 'three';
import { useSpring as useReactSpring, animated, config } from '@react-spring/web';
import { useHover, useWindowSize } from '@mantine/hooks';
