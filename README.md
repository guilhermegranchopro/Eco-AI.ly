# GAIA: Your Green AI Assistant by Eco AI.ly <img src="branding/eco_ai.ly/logo.png" alt="Eco AI.ly Logo" width="500"/>
...
```
**→ Access API docs at [http://localhost:8080/docs](http://localhost:8080/docs)**

### 🎯 Platform Access Points

| Component | URL | Status | Description |
|-----------|-----|--------|-------------|
| **Streamlit Dashboard** | [http://localhost:8501](http://localhost:8501) | ✅ Production Ready | Full-featured analytics dashboard |
| **Next.js Web App** | [http://localhost:3000](http://localhost:3000) | ✅ Enhanced UI | Modern web interface with advanced features |
| **FastAPI Backend** | [http://localhost:8080](http://localhost:8080) | ✅ Operational | AI prediction API service |
| **Live Deployment** | [ecoaily.streamlit.app](https://ecoaily.streamlit.app/) | 🌐 Live | Public Streamlit deployment |
...
**Required API Keys:**
- **ElectricityMaps API**: For real-time energy data ([Get API Key](https://www.electricitymaps.com/))
...
1. **Get API Key**: Visit [ElectricityMaps API](https://www.electricitymaps.com/api)
2. **Choose Plan**: Free tier available for development
3. **Configure**: Add key to `.env` files
4. **Test Connection**: Use API documentation endpoints
...
6. **Screenshots**: If applicable, visual evidence
...
2. Email directly: [security@ecoai.ly](mailto:security@ecoai.ly)
...
- **Email**: [dev@ecoai.ly](mailto:dev@ecoai.ly) for development questions
...
**Currently Deployed:**
- **Streamlit Dashboard**: [https://ecoaily.streamlit.app/](https://ecoaily.streamlit.app/)
...
#### 📡 External APIs
- **ElectricityMaps API**: Subject to [ElectricityMaps Terms of Service](https://www.electricitymaps.com/terms-of-service)
...
- **GitHub**: [@guilhermegranchopro](https://github.com/guilhermegranchopro)
- **LinkedIn**: [guilherme-grancho](https://linkedin.com/in/guilherme-grancho)
- **Location**: Portugal 🇵🇹

#### 🌐 Project Links
- **Live Application**: [https://ecoaily.streamlit.app/](https://ecoaily.streamlit.app/)
- **GitHub Repository**: [https://github.com/guilhermegranchopro/Eco-AI.ly](https://github.com/guilhermegranchopro/Eco-AI.ly)
- **Project Website**: [https://eco-ai.ly](https://eco-ai.ly) *(coming soon)*
- **Documentation**: Available in repository `/docs` folder

#### 💬 Community & Support

**Getting Help:**
- **GitHub Issues**: [Report bugs or request features](https://github.com/guilhermegranchopro/Eco-AI.ly/issues)
- **GitHub Discussions**: [Community questions and discussions](https://github.com/guilhermegranchopro/Eco-AI.ly/discussions)
- **Email Support**: [support@ecoai.ly](mailto:support@ecoai.ly) *(coming soon)*
...
- **Business Email**: [business@ecoai.ly](mailto:business@ecoai.ly) *(coming soon)*
