...
def render_import_export_info():
    ...
    - **Energy Import**: Electricity purchased from other countries when domestic production is insufficient to meet demand
    - **Energy Export**: Electricity sold to other countries when domestic production exceeds local consumption needs
    ...
    - **Bidirectional Flow**: Electricity can flow in either direction depending on supply and demand conditions
    - **Real-Time Balancing**: Flows are constantly adjusted to maintain grid stability across borders
    ...
    - **Risk Mitigation**: Managing the impact of domestic production disruptions
    ...
    - **Load Balancing**: Using imports/exports to manage supply-demand imbalances
    ...
    - **Emissions Trading**: The environmental implications of energy trade
    - **Climate Goals**: Supporting national and international climate targets
    
    ## Eco AI.ly's Import/Export Tools and Features
    ...
    - **Source Distribution**: Visual representation of electricity imported from different countries
    ...
    - **Destination Analysis**: Distribution of electricity exports to different countries
    ...
    - **Import Metrics**: Total imports, average hourly imports, and breakdown by source
    - **Export Metrics**: Total exports, average hourly exports, and breakdown by destination
    - **Balance Metrics**: Net import/export position, import/export ratio, total energy flow
    ...
    - **Risk Management**: Develop strategies to manage price and volume risks
    - **Portfolio Optimization**: Balance import and export positions
    - **Forecasting**: Predict future import/export patterns
    - **Contract Negotiation**: Use data to inform trading agreements
    
    ### For Grid Operators
    
    - **Grid Planning**: Optimize transmission capacity for imports/exports
    - **Congestion Management**: Identify and address transmission bottlenecks
    - **Stability Control**: Maintain grid stability across borders
    ...
    - **Infrastructure Planning**: Identify needs for new interconnections
    ...
    - **Risk Assessment**: Evaluate exposure to import/export-related risks
    ...
    - **Imported Electricity**: Carries the carbon intensity of the exporting country
    - **Exported Electricity**: Transfers Portugal's carbon intensity to importing countries
    - **Net Effect**: The overall environmental impact depends on the carbon intensity difference
