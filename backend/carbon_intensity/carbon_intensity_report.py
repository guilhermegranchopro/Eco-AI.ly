...
def generate_carbon_intensity_pdf_report(data, charts=None, title="Carbon Intensity Portugal Overview"):
    ...
    try:
        ...
        logo_width = 150
        logo_height = 50
        pdf.image("assets/images/logo.png", pdf.w/2 - logo_width/2, pdf.get_y(), logo_width, logo_height)
    ...
    if data and len(data) >= 4:
        ...
        if value_displayed_now != value_displayed_next:
            ...
            recommendation = "Carbon intensity is expected to remain stable in the next 24 hours."
