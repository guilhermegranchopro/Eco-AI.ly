...
def display_model_stats(model_name: str, base_path: str):
    ...
    tab1, tab2, tab3, tab4 = st.tabs(["Performance Metrics", "Training Visualization", "Confusion Matrix", "Model Details"])
...
def rend_model_stats_RP():
    ...
    st.markdown("*Comprehensive performance metrics and visualizations for our AI models*")
