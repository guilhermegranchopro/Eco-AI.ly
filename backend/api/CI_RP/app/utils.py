...
SCALER_RP_PATH = os.getenv("SCALER_RP_PATH", "scaler_renewable_percentage.pkl")
SCALER_CI_PATH = os.getenv("SCALER_CI_PATH", "scaler_carbon_intensity.pkl")
MODEL_RP_PATH = os.getenv("MODEL_RP_PATH", "model_renewable_percentage.keras")
MODEL_CI_PATH = os.getenv("MODEL_CI_PATH", "model_carbon_intensity.keras")
